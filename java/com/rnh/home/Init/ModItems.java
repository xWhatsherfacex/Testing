...
import com.rnh.home.Items.Items.ItemJuicePressBlock;
...
public class ModItems {
	...
	public static ItemBase ITEM_JUICE_PRESS_BLOCK = new ItemJuicePressBlock("item_juice_press_block", ModBlocks.JUICE_PRESS_BLOCK).setCreativeTab(Main.MAINTAB);
